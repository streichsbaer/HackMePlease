module.exports = {
   ...
   // That will create the local hackmeplease data-store, or restore it to a clean state if it already exists.

   // db: "mongodb://localhost:27017/hackmeplease",

   // If you want to use a MongoLab instance, just sign up for it, create a data-store, in this example we call it hackmeplease.
